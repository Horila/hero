-- ============================================================
-- Adds a "needs dipping" flag, settable from your Summary page,
-- surfaced as a warning banner on the trolley boys' job cards.
-- Run once in Supabase SQL Editor.
-- ============================================================

alter table jobs add column if not exists needs_dipping boolean default false;
